...
LABELS = {
        ...
        "httpd_sys_content_t": [
                ...
                ("%s(/.*)?", os.path.join(BASE_DIR, "srv/splice")),
        ],
        "lib_t": [
                ("%s(/.*)?", os.path.join(BASE_DIR, "src")),
        ],
        "httpd_initrc_exec_t": [
                ("%s(/.*)?", os.path.join(BASE_DIR, "etc/rc.d/init.d/splice_all")),
                ("%s(/.*)?", os.path.join(BASE_DIR, "etc/rc.d/init.d/splice_celeryd")),
                ("%s(/.*)?", os.path.join(BASE_DIR, "etc/rc.d/init.d/splice_celerybeat")),
        ],
}
